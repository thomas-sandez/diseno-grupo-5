...
const MemoriaAnual = () => {
  ...
  const confirmRemoveIntegrante = async () => {
    ...
    if (integrante.temp || !memoriaId) {
      setFormData(prev => ({
        ...prev,
        integrantes: prev.integrantes.filter(i => i.oidPersona !== integrante.oidPersona)
      }));
  ...
  const handleGuardarMemoria = async () => {
    try {
      ...
      const tituloMensaje = formData.titulo ? `"${formData.titulo}"` : `del año ${formData.ano}`;
      const fechaCreacion = new Date(memoriaCreada.fechaCreacion).toLocaleString('es-ES', {
        day: '2-digit',
        month: '2-digit',
        year: 'numeric',
        hour: '2-digit',
  ...
  const getConfirmMessage = () => {
    ...
    if (type === 'guardar') {
      const tituloTexto = formData.titulo ? ` "${formData.titulo}"` : ` del año ${formData.ano}`;
      return `¿Está seguro que desea guardar la Memoria Anual${tituloTexto}?\n\nEsta acción creará un registro permanente con todos los datos ingresados.`;
    }
    return '';
  };
      ...
      <div className="tabs-container">
        ...
        <div className="tab-panel">
            ...
            <div className="tab-content">
              ...
              <div className="form-section" style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                ...
                <div className="form-group" style={{ flex: 1, minWidth: '300px' }}>
                  ...
                  <input
                    type="text"
                    placeholder="Ej: Memoria de Investigación en Inteligencia Artificial"
              ...
              <div style={{ marginTop: '40px' }}>
                ...
                <div style={{ marginBottom: '20px', display: 'flex', gap: '10px', alignItems: 'stretch' }}>
                  <div ref={integrantesSearchRef} className="search-container">
                      ...
                      <div className="search-dropdown">
                        {getPersonasDisponibles().length > 0 ? (
                          getPersonasDisponibles().map((persona) => (
                            ...
                            >
                              <div className="dropdown-item-title">{persona.nombre} {persona.apellido}</div>
                              <div className="dropdown-item-subtitle">{persona.tipoDePersonalNombre || 'Sin tipo'}</div>
                            </div>
                          ))
                        ) : (
                            ...
                            filtradas.map((persona) => (
                              ...
                              >
                                <div className="dropdown-item-title">
                                  {highlightText(`${persona.nombre} ${persona.apellido}`, searchTerms.integrantes)}
                                </div>
                                <div className="dropdown-item-subtitle">{persona.tipoDePersonalNombre || 'Sin tipo'}</div>
                              </div>
                            ))
          ...
          {activeTab === 'trabajos' && (
            <div className="tab-content">
              <div style={{ marginBottom: '20px', display: 'flex', gap: '10px', alignItems: 'stretch' }}>
                <div ref={trabajosSearchRef} className="search-container">
                  <div className="search-input-wrapper">
                    <Search size={18} className="search-icon" />
                    <input
                      type="text"
                      ...
                      {getTrabajosDisponibles().length > 0 ? (
                        getTrabajosDisponibles().map((trabajo) => (
                          <div
                            ...
                            className="search-dropdown-item"
                          >
                            <div className="dropdown-item-title">{trabajo.tituloTrabajo}</div>
                      ...
                      {(() => {
                        ...
                        return filtrados.length > 0 ? (
                          filtrados.map((trabajo) => (
                            ...
                            >
                              <div className="dropdown-item-title">
                                {highlightText(trabajo.tituloTrabajo, searchTerms.trabajos)}
                              </div>
                              <div className="dropdown-item-subtitle">
                                {highlightText(trabajo.ciudad, searchTerms.trabajos)} - {highlightText(trabajo.nombreReunion, searchTerms.trabajos)}
                              </div>
                            </div>
                          ))
                        ) : (
        ...
        {activeTab === 'actividades' && (
          <div className="tab-content">
            <div style={{ marginBottom: '20px', display: 'flex', gap: '10px', alignItems: 'stretch' }}>
              <div ref={actividadesSearchRef} className="search-container">
                <div className="search-input-wrapper">
                  <Search size={18} className="search-icon" />
                  <input
                    type="text"
                    ...
                    {getActividadesDisponibles().length > 0 ? (
                      getActividadesDisponibles().map((actividad) => (
                        <div
                          ...
                          className="search-dropdown-item"
                        >
                          <div className="dropdown-item-title">{actividad.descripcion}</div>
                          <div className="dropdown-item-subtitle">
                    ...
                    {(() => {
                      ...
                      return filtrados.length > 0 ? (
                        filtrados.map((actividad) => (
                          ...
                          >
                            <div className="dropdown-item-title">
                              {highlightText(actividad.descripcion, searchTerms.actividades)}
                            </div>
                            <div className="dropdown-item-subtitle">
                              {actividad.fechaInicio} - {actividad.fechaFin}
                            </div>
        ...
        {activeTab === 'publicaciones' && (
          <div className="tab-content">
            <div style={{ marginBottom: '20px', display: 'flex', gap: '10px', alignItems: 'stretch' }}>
              <div ref={publicacionesSearchRef} className="search-container">
                <div className="search-input-wrapper">
                  <Search size={18} className="search-icon" />
                  <input
                    type="text"
                    ...
                    {(() => {
                      ...
                      return filtrados.length > 0 ? (
                        filtrados.map((publicacion) => (
                          ...
                          >
                            <div className="dropdown-item-title">
                              {highlightText(publicacion.titulo, publicacionesDropdownSearch)}
                            </div>
                            <div className="dropdown-item-subtitle">
                              {highlightText(publicacion.nombreRevista || 'Sin revista', publicacionesDropdownSearch)}
                            </div>
                          </div>
                        ))
                      ) : (
          ...
          {activeTab === 'patentes' && (
            <div className="tab-content">
              <div style={{ marginBottom: '20px', display: 'flex', gap: '10px', alignItems: 'stretch' }}>
                <div ref={patentesSearchRef} className="search-container">
                  <div className="search-input-wrapper">
                    <Search size={18} className="search-icon" />
                    <input
                      type="text"
                      ...
                      {(() => {
                        ...
                        return filtradas.length > 0 ? (
                          filtradas.map((patente) => (
                            ...
                            >
                              <div className="dropdown-item-title">
                                {highlightText(patente.descripcion, searchTerms.patentes)}
                              </div>
                              <div className="dropdown-item-subtitle">
                                Número: {highlightText(patente.numero, searchTerms.patentes)} | Tipo: {patente.tipo} | Fecha: {patente.fecha}
                              </div>
                            </div>
                          ))
                        ) : (
          ...
          {activeTab === 'proyectos' && (
            <div className="tab-content">
              <div style={{ marginBottom: '20px', display: 'flex', gap: '10px', alignItems: 'stretch' }}>
                <div ref={proyectosSearchRef} className="search-container">
                  <div className="search-input-wrapper">
                    <Search size={18} className="search-icon" />
                    <input
                      type="text"
                      ...
                      {(() => {
                        ...
                        return filtrados.length > 0 ? (
                          filtrados.map((proyecto) => (
                            ...
                            >
                              <div className="dropdown-item-title">
                                {highlightText(proyecto.nombre, searchTerms.proyectos)}
                              </div>
                              <div className="dropdown-item-subtitle">
                                Código: {highlightText(proyecto.codigoProyecto, searchTerms.proyectos)} | Tipo: {proyecto.tipoProyecto}
                              </div>
                            </div>
                          ))
                        ) : (
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                  ...
                  {formData.titulo && (
                    <div style={{ padding: '10px', backgroundColor: '#fff', borderRadius: '4px', gridColumn: '1 / -1' }}>
              ...
              <div style={{ 
                ...
                <p style={{ color: '#7b1fa2', margin: '0' }}>
                  Esta acción creará un registro permanente de la memoria anual{formData.titulo ? ` "${formData.titulo}"` : ` del año ${formData.ano}`}.
                </p>
              </div>
